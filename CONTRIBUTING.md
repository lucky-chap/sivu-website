Thanks for showing interest to contribute to Sivu-Tutorials 💖, you rock!
...
> If you run into any issues, kindly reach out to the Sivu React team here:
> https://discord.gg/npzvuhf7z7
...
1. Fork of the website repository and clone your fork
...
3. Make and commit your changes following the
   [commit convention](https://github.com/Sivu-Tutorials/website/blob/main/CONTRIBUTING.md#commit-convention).
...
Visit
https://github.com/settings/tokens/new?description=sivu+website+development to
...
By contributing your code to the Sivu Tutorials website GitHub repository, you agree to
